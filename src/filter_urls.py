...
if __name__ == "__main__":
    output_file = r"C:\Users\rishi\ClientX_train_data.txt" # Replace with your output file
    urls_file = r"C:\Users\rishi\ClientX Recognotion\urls.txt" # Replace with your urls file
    wordlist_file = r"empty.txt" # Replace with your wordlist file
