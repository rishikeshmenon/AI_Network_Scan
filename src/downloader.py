...
def main():
    keywords = ["AxisBankWebpage","DailyMotionWebpage","ClientXWebpage","TataSteelWebpage"] #Add the keywords of which you want to dowanload images of. Make sure there are no spaces in any keyword
